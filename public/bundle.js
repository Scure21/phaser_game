...
// This is where we tell our components to render
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.preload = _this.preload.bind(_this);
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      var gameInstance = new Phaser.Game(800, 600, Phaser.AUTO, "app", {
        preload: this.preload,
        create: _game.create,
        update: _game.update
      });
      !this.state.game && this.setState({ game: gameInstance }, function (gameInstance) {
        return _this2.preload(_this2.state.game);
      });
      // this.create(gameInstance);
    }
  }, {
    key: "preload",
    value: function preload(gameInstance) {
